...
# this file has been manually copied from
# https://raw.githubusercontent.com/grindsa/acme2certifier/refs/heads/devel/examples/ca_handler/acme_ca_handler.py
# because of https://github.com/grindsa/acme2certifier/issues/252
#
# it should be removed when the issue is fixed in acme2certifier package
